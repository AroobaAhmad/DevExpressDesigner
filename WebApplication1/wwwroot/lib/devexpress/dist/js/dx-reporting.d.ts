...
declare module DevExpress.Reporting.Designer.Internal {
    ...
    export class SqlDataSourceEditor extends DataSourceEditorBase {
        ...
        static rebuildResultSchema(source: DevExpress.Analytics.Data.SqlDataSource, queryName?: string, relationsEditing?: boolean, parameters?: DevExpress.Analytics.Wizard.Internal.IParameter[]): DevExpress.Analytics.Internal.DxPromise<IRebuildSchemaResponse>;
        static createSqlDataSourceInfo(source: DevExpress.Analytics.Data.SqlDataSource, queryName?: string, relationsEditing?: boolean, parameters?: DevExpress.Analytics.Wizard.Internal.IParameter[]): DevExpress.Analytics.Internal.DxPromise<IDataSourceInfo>;
        addAction: {
            clickAction: (item: any) => void;
            imageClassName: string;
            imageTemplateName: string;
