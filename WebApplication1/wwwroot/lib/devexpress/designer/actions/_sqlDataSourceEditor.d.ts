...
export declare class SqlDataSourceEditor extends DataSourceEditorBase {
    ...
    static rebuildResultSchema(source: SqlDataSource, queryName?: string, relationsEditing?: boolean, parameters?: IParameter[]): DxPromise<IRebuildSchemaResponse>;
    static createSqlDataSourceInfo(source: SqlDataSource, queryName?: string, relationsEditing?: boolean, parameters?: IParameter[]): DxPromise<IDataSourceInfo>;
    addAction: {
